  ...
  return (
    <section id="amenities" className="bg-cream py-20 sm:py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 grid grid-cols-3 gap-3 sm:mt-14 sm:grid-cols-2 sm:gap-6 lg:grid-cols-5">
          {features.map((f) => {
            const Icon = f.icon;
            return (
              <article
                key={f.title}
                className="group rounded-2xl border border-border bg-card p-3 text-center shadow-sm transition hover:-translate-y-1 hover:border-accent hover:shadow-warm sm:p-6 sm:text-left"
              >
                <div className="mx-auto flex h-10 w-10 items-center justify-center rounded-xl bg-accent/20 text-accent transition group-hover:bg-accent group-hover:text-accent-foreground sm:mx-0 sm:h-12 sm:w-12">
                  <Icon className="h-5 w-5 sm:h-6 sm:w-6" />
                </div>
                <h3 className="mt-3 font-display text-sm font-bold leading-tight text-primary sm:mt-5 sm:text-lg">{f.title}</h3>
                <p className="hidden text-sm leading-relaxed text-muted-foreground sm:mt-2 sm:block">{f.desc}</p>
              </article>
            );
          })}
        </div>
...
function ReviewSection() {
  ...
  return (
    <section className="bg-background py-20 sm:py-28">
      <div className="mx-auto grid max-w-6xl gap-12 px-4 sm:px-6 md:grid-cols-5 md:items-start lg:px-8">
        ...
        <div className="md:col-span-3">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center rounded-full bg-accent px-5 py-2.5 text-sm font-semibold text-accent-foreground shadow-warm transition hover:scale-[1.02]"
            >
              More Mirpur reviews
            </a>
            <a
              href="https://maps.app.goo.gl/quPKGMr92tmDsLRx7"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center rounded-full bg-primary px-5 py-2.5 text-sm font-semibold text-primary-foreground shadow-soft transition hover:scale-[1.02]"
            >
              More Gulshan reviews
            </a>
          </div>
        </div>
      </div>
